...
import type { AppStatus, Meeting, Utterance } from "./lib/api";
...
export default function App() {
  ...
  useEffect(() => {
    api.status().then(setAppStatus).catch(console.error);
  }, []);
  ...
  const handleMeetingStarted = (id: number) => {
  ...
  const handleMeetingDeleted = (ids: number[]) => {
